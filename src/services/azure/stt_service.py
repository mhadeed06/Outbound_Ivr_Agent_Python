...
#         segmentation_silence_ms: int = 1600,  # NEW: Accept as parameter
#     ):
...
#             str(segmentation_silence_ms)   # Don't finalize until 1.4 seconds of silence only for oscar, 600 for cingna
#         )
